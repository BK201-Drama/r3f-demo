...
declare global {
  ...
  const FunctionComponentElement: typeof import('react')['FunctionComponentElement']
  ...
  const boxStore: typeof import('@/core/box/store/index.store')['boxStore']
  ...
  const lineStore: typeof import('@/core/line/store/index.store')['lineStore']
